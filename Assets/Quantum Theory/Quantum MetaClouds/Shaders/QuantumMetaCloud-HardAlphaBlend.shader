...
_AmbientColor("Ambient Color of Clouds", Color) = (0.2078431,0.2588235,0.2990392,1)
_SunColor("Sun Color of Clouds", Color) = (0.997612,0.9254484,0.882769,1)
_CloudContrast("Cloud Contrast", Range(0.1,3) ) = 1.3
_Bias("Cloud Density", Range(0.25,0.95) ) = 0.65
_AlphaCutoff("Cloud Opacity", Range(1,0) ) = 0
